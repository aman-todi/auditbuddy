...
const AdvancedResultsPage = () => {
  ...
  const { brandName, dealershipName } = useParams();
  ...
  const fetchLogoResults = () => {
    fetch(`/get-logo-results/${encodeURIComponent(decodedBrandName)}/${encodeURIComponent(decodedDealershipName)}`)
  ...
  const fetchCarResults = () => {
    fetch(`/get-car-results/${encodeURIComponent(decodedBrandName)}/${encodeURIComponent(decodedDealershipName)}`)
      .then(response => response.json())
      .then(data => {
  ...
  const fetchParkingResults = () => {
    fetch(`/get-parking-results/${encodeURIComponent(decodedBrandName)}/${encodeURIComponent(decodedDealershipName)}`)
      .then(response => response.json())
      .then(data => {
  ...
  const fetchHospitalityResults = () => {
    fetch(`/get-hospitality-results/${encodeURIComponent(decodedBrandName)}/${encodeURIComponent(decodedDealershipName)}`)
      .then(response => response.json())
      .then(data => {
  ...
  const fetchSpatialResults = () => {
    fetch(`/get-spatial-results/${encodeURIComponent(decodedBrandName)}/${encodeURIComponent(decodedDealershipName)}`)
      .then(response => response.json())
      .then(data => {
  ...
  return (
    <React.Fragment>
      <Container maxWidth="lg" style={{ marginTop: '6rem', marginLeft: '12rem' }}> {/* Apply margin: auto */}
        <MaterialUI.SideBar />
        <Typography variant="h4" gutterBottom align="center">AuditBuddy Results for {decodedDealershipName}</Typography>
